...
const CalibrationPhase: React.FC = () => {
  ...
  const [calibrationClickPositions, setCalibrationClickPositions] = useState<
    { x: number; y: number }[]
  >([]);
  const uploadedImageUrl = state.uploadedImage
    ? URL.createObjectURL(state.uploadedImage)
    : null;
  const [selectedImage, setSelectedImage] = useState<string | null>(null);
  const [circleSize, setCircleSize] = useState(
    state.calibrationData.circles[0]?.size || 20
  );
  ...
  const handleExposureMaskingChange = (newState: {
    enabled: boolean;
    value: number;
  }) => {
    updateExposureMaskSettings({
  ...
  return (
    <div
      className="w-full min-h-screen px-2 py-4"
    ...
    >
        ...
        <div className="flex gap-4 items-center">
          ...
          {calibration && (
            <span className="text-sm text-slate-700">
              ...
              {calibration.shade} LAB L*{calibration.officialLab.L.toFixed(1)},
              a*{calibration.officialLab.a.toFixed(1)}, b*
                ...
                <div className="flex flex-col justify-start font-manrope text-gray-900 w-full mt-4">
                  ...
                  <div className="mb-4 flex flex-col gap-2">
                    <div className="flex flex-col gap-2 mb-3">
                      ...
                      <span className="text-xs font-manrope text-gray-900">
      ...
      <Dialog open={isSkipDialogOpen} onOpenChange={setIsSkipDialogOpen}>
        <DialogContent className="bg-[#ECEDEF] border-0">
          <DialogHeader>
            <DialogTitle className="text-black font-manrope font-extralight">
              Cancel Calibration?
            </DialogTitle>
