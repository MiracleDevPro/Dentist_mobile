...
import ColorDataPanel from "../colorMobileDataPanel";
...
const AnalysisPhase: React.FC = () => {
  ...
  const processedImageUrl = state.uploadedImage
  ...
  useEffect(() => {
    ...
    console.log("processImgUrl", processedImageUrl);
  }, []);

  return (
    <div className="px-6 py-4 w-full max-w-4xl mx-auto bg-[#ecedef]">
      <p className="text-center text-sm text-gray-600 font-manrope font-extralight mb-3">
        Place The Circle in order to see the Shade
      </p>
            ...
            <div className="flex items-center justify-center h-96 rounded-2xl border-2 border-gray-400 bg-[#ecedef]/80">
              <div className="text-center">
                <p className="text-slate-600 text-lg">
                  Please upload an image in the panel above to begin analysis
                </p>
              </div>
            </div>
          )}
      ...
      <TabContent active={activeTab === "controls"}>
        <div className="mt-4 mb-2 bg-transparent relative">
          <div className="px-4 py-2 relative z-0">
            <h3 className="text-lg text-black font-manrope font-light mb-3">
              Analysis Controls
            </h3>
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <Label
                    htmlFor="analysis-circle-size"
                    className="text-base text-black font-manrope font-light"
                  >
                    Analysis Circle Size
                  </Label>
                  <span className="text-sm text-black font-manrope font-extralight">
                    {analysisCircleSize}px
                  </span>
                </div>
                <Slider
              ...
              <div className="space-y-2 pt-2">
                <div className="flex items-center justify-between mb-1">
                  <Label
                    htmlFor="analysis-exposure-threshold"
                    className="text-base text-black font-manrope font-light"
                  >
        ...
        <div className="border border-dotted border-gray-500 rounded-lg mt-4 mb-2 bg-transparent relative overflow-hidden">
          <div className="px-6 py-4 relative z-0">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-lg text-black font-manrope font-light">
                AI Features
              </h3>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={() =>
                    toggleFeature("useClinicalSuggestions")
                  }
                />
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="bg-green-50 border border-green-100 rounded-lg p-3">
                ...
                <p className="text-sm text-black">
                  For this A2 shade, consider a two-layer approach with a dentin
                  core and enamel overlay.
                </p>
              </div>
