...
export const ClinicalLayeringInfo: React.FC = () => (
  <Dialog>
    <DialogTrigger asChild>
      <button type="button" className="ml-2 flex items-center justify-center" aria-label="Information about clinical layering suggestions">
        <Info className="w-4 h-4 text-gray-700" />
      </button>
    </DialogTrigger>
    <DialogContent className="sm:max-w-md bg-[#ECEDEF] text-black font-manrope border border-gray-300 shadow-lg z-[9999]">
      <DialogHeader>
        <DialogTitle className="text-black font-manrope">Clinical Layering Suggestions</DialogTitle>
        <DialogDescription className="text-black font-manrope">
          <div className="mt-2 text-left text-sm">
            <p className="mb-2"><span className="font-bold">What it does:</span> Recommends how to build up a restoration using multiple composite or ceramic layers for the best shade match.</p>
            <ul className="text-xs list-disc pl-4 mb-2">
              <li>Analyzes your tooth's LAB values vs. VITA reference</li>
              <li>Suggests layer materials and opacities based on color differences</li>
            </ul>
            <div className="text-xs mt-2">
              <span className="font-semibold">Clinical value:</span> Helps you select the right layering technique for a natural result.<br/>
              <span className="font-semibold">Example:</span> If the tooth is lighter than reference, use a more translucent enamel or brighter dentin layer.
            </div>
          </div>
        </DialogDescription>
      </DialogHeader>
          ...
          <div className="flex-1">
            <div className="flex items-center">
              ...
              <Dialog>
                ...
                <DialogContent className="sm:max-w-md bg-[#ECEDEF] text-black font-manrope border border-gray-300 shadow-lg z-[9999]">
                  <DialogHeader>
                    <DialogTitle className="text-black font-manrope">HSV Color Space</DialogTitle>
                    <DialogDescription className="text-black font-manrope">
                      <div className="mt-2 text-left text-sm">
                        <p className="mb-2"><span className="font-bold">What it does:</span> HSV Color Space uses hue, saturation, and value to analyze tooth color. This can distinguish subtle shade differences that LAB may miss.</p>
                        <ul className="text-xs list-disc pl-4 mb-2">
                          <li>Improves shade family detection (A, B, C, D)</li>
                          <li>Helps spot translucency and color intensity</li>
                        </ul>
                        <div className="text-xs mt-2">
                          <span className="font-semibold">Example:</span> HSV can tell apart two shades with similar brightness but different hues, helping you select the best match.
                        </div>
                      </div>
                    </DialogDescription>
                  </DialogHeader>
        ...
        <div className="py-3 flex justify-between items-center border-b border-[#e6e7ea]">
          <div className="flex-1">
            <div className="flex items-center">
              ...
              <Dialog>
                <DialogTrigger asChild>
                  <button type="button" className="ml-2 flex items-center justify-center" aria-label="Information about exposure masking">
                    <Info className="w-4 h-4 text-gray-700" />
                  </button>
                </DialogTrigger>
                <DialogContent className="sm:max-w-md bg-[#ECEDEF] text-black font-manrope border border-gray-300 shadow-lg z-[9999]">
                  <DialogHeader>
                    <DialogTitle className="text-black font-manrope">Exposure Masking</DialogTitle>
                    <DialogDescription className="text-black font-manrope">
                      <div className="mt-2 text-left text-sm">
                        <p className="mb-2"><span className="font-bold">What it does:</span> Detects and masks areas that are too bright or too dark in your image to prevent unreliable color analysis.</p>
                        <ul className="text-xs list-disc pl-4 mb-2">
                        ...
                        <div className="text-xs mt-2">
                          <span className="font-semibold">Clinical value:</span> Ensures only valid, clinically meaningful regions are used for shade matching.<br/>
                          <span className="font-semibold">Example:</span> A white flash spot or deep shadow is ignored to avoid skewing shade results.
                        </div>
                      </div>
                    </DialogDescription>
                  </DialogHeader>
          ...
          <div className="flex-1">
            <div className="flex items-center">
              ...
              <Dialog>
                ...
                <DialogContent className="sm:max-w-md bg-[#ECEDEF] text-black font-manrope border border-gray-300 shadow-lg z-[9999]">
                  <DialogHeader>
                    <DialogTitle className="text-black font-manrope">Weighted Delta-E</DialogTitle>
                    <DialogDescription className="text-black font-manrope">
                      <div className="mt-2 text-left text-sm">
                        <p className="mb-2"><span className="font-bold">What it does:</span> Weighted Delta-E gives more importance to color differences that matter most for tooth shade matching, making results more clinically relevant.</p>
                        <ul className="text-xs list-disc pl-4 mb-2">
                          <li>Focuses on color shifts that are most visible to the human eye</li>
                          <li>Improves confidence in shade selection</li>
                        </ul>
                        <div className="text-xs mt-2">
                          <span className="font-semibold">Example:</span> If two teeth differ mainly in yellow/blue, Weighted Delta-E highlights this so you can adjust your shade choice accordingly.
                        </div>
                      </div>
                    </DialogDescription>
                  </DialogHeader>
